...
BesselCurve::BesselCurve(size_t sampleSizeInit) :
...
void BesselCurve::push_ctrl_points(const QPointF& p) 
{ 
	ctrl_points_.push_back(p);
	de_casteljao();
}

void BesselCurve::pop_ctrl_points() 
{ 
